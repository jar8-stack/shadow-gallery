...
function SignInFacebook(){
  ...
  return(<>
    <button className="sign-in" onClick={signInWithFacebook}> Entrar con facebook </button>
    <br />
    <br />
...
const {uid, email, photoURL, lastTime}= promps.user;
  ...
  return(<>
    <div className="chat_people">
                    ...
                    <div className="chat_ib">
                      ...
                      <h5>{email} <br /> <span className="chat_date" style={{color: "black"}}>{lastTime.toDate().toString()}</span></h5>
                      <p>Test, which is a new approach to have all solutions 
                        astrology under one roof.</p>
                        </Link>
                    </div>
